...
### Fixed
- Normalize multiline supervised outcomes to a single line before rendering the status widget goal, preventing embedded newlines from breaking the widget layout.

## [0.5.0] - 2026-05-25

### Changed
- Migrated core pi package imports and peer dependencies from the legacy `@mariozechner/*` scope to the official `@earendil-works/*` namespace, following the current pi documentation.
- Updated the lockfile against the official `@earendil-works` packages and rebuilt the extension successfully against that namespace.
...
[0.5.1]: https://github.com/tintinweb/pi-supervisor/compare/v0.5.0...v0.5.1
[0.5.0]: https://github.com/tintinweb/pi-supervisor/compare/v0.4.4...v0.5.0
